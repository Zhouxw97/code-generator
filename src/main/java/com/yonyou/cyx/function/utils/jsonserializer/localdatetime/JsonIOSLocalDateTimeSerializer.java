...
public class JsonIOSLocalDateTimeSerializer extends JsonSerializer<LocalDateTime> {
    ...
    public void serialize(LocalDateTime value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern(FunctionConstants.IOS_8601_DATE_FORMAT);
