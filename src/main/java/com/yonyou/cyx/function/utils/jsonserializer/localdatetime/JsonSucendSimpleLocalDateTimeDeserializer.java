...
public class JsonSucendSimpleLocalDateTimeDeserializer extends JsonDeserializer<LocalDateTime> {
    ...
    public LocalDateTime deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        try {
            if (StringUtils.isNullOrEmpty(date)) {
                ...
                return LocalDateTime.parse(date, DateTimeFormatter.ofPattern(FunctionConstants.ACCURATE_DATE_FORMAT));
            }
        } catch (Exception e) {
