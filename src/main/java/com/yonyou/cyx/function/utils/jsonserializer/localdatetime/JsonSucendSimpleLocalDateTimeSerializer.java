...
public class JsonSucendSimpleLocalDateTimeSerializer extends JsonSerializer<LocalDateTime> {
    ...
    public void serialize(LocalDateTime value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern(FunctionConstants.ACCURATE_DATE_FORMAT);
