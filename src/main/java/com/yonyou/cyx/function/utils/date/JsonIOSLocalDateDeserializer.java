...
public class JsonIOSLocalDateDeserializer extends JsonDeserializer<Date> {
    ...
    public Date deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        SimpleDateFormat format = new SimpleDateFormat(FunctionConstants.IOS_8601_DATE_FORMAT);
