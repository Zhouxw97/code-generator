...
public class JsonSimpleLocalDateDeserializer extends JsonDeserializer<LocalDate> {
    ...
    public LocalDate deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        try {
            if (StringUtils.isNullOrEmpty(date)) {
                ...
                return LocalDate.parse(date, DateTimeFormatter.ofPattern(FunctionConstants.SIMPLE_DATE_FORMAT));
            }
        } catch (Exception e) {
