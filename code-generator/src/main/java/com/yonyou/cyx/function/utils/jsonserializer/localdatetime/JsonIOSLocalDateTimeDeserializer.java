...
public class JsonIOSLocalDateTimeDeserializer extends JsonDeserializer<LocalDateTime> {
    ...
    public LocalDateTime deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        try {
            return LocalDateTime.parse(date, DateTimeFormatter.ofPattern(FunctionConstants.IOS_8601_DATE_FORMAT));
        } catch (Exception e) {
